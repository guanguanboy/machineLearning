...
#参考自：https://blog.csdn.net/weixin_39198406/article/details/104599246
...
print('计算数据集均值标准差')
batch_size = 64
#train_iter, test_iter = load_data_fashion_mnist(batch_size, root='./Datasets/FashionMNIST',
#                                               use_normalize=False)
...
data_transforms_112_gray = {
        'train': transforms.Compose([
            ...
            transforms.Normalize([0.56],[0.07])
        ...
        'val': transforms.Compose([
            ...
            transforms.Normalize([0.26],[0.08])
            #transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])
        ]),
    }
...
image_datasets_gray = {x: datasets.ImageFolder(os.path.join(data_dir, x),
                       ...
                       for x in ['train', 'val']}
#train_iter = datasets.ImageFolder(os.path.join(data_dir, 'train'),
#                                               data_transforms_112_gray['train'])

#test_iter = datasets.ImageFolder(os.path.join(data_dir, 'val'),
#                                               data_transforms_112_gray['val'])
